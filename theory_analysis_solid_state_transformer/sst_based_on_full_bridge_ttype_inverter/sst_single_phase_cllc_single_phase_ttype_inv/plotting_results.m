...
t1c = time_tc_sim(end) - glb_time.Nc*glb_time.tc/2000;
t2c = time_tc_sim(end);
t1s = time_ts_dab_sim(end) - (glb_time.Ns_dab*glb_time.ts_dab/10);
t2s = time_ts_dab_sim(end);
t3s = time_ts_dab_sim(end) - (glb_time.Ns_dab*glb_time.ts_dab/10);
t4s = time_ts_dab_sim(end);
t5s = time_ts_dab_sim(end) - (glb_time.Ns_dab*glb_time.ts_dab/20);
t6s = time_ts_dab_sim(end);
t3c = time_tc_sim(end) - (glb_time.Nc*glb_time.tc/1000);
t4c = time_tc_sim(end);
t5c = time_tc_sim(end) - (glb_time.Nc*glb_time.tc/2000);
t6c = time_tc_sim(end);
